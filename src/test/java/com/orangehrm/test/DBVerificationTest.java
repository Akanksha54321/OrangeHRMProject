...
//		SoftAssert softAssert =  new SoftAssert();// you can create instance of SoftAssert class but it won't be thread safe
		//so better to instantiate in Base Class then call here
		
		SoftAssert softAssert = getSoftAssert();
		 ExtentManager.startTest("DB Verification Test"); //--This has been
