...
public class HomePage1 {
	...
	/*
	 * Initialize the ActionDriver object by passing WebDriver instance initilizing
	 * Action Driver here causing problem of creating new WebDriver instance better
	 * to use Singleton pattern where we initilize it in BaseClass1
	 */
//	
